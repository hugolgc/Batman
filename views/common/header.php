  ...
  <header>
    <nav class="container">
      ...
      <ul id="menu">
        ...
        <li>
          <a href="/movies" class="<?= $_SERVER["REQUEST_URI"] === "/movies" ? "active" : "" ?>">Films</a>
        </li>
        <li>
          <a href="/actors" class="<?= $_SERVER["REQUEST_URI"] === "/actors" ? "active" : "" ?>">Acteurs</a>
        </li>
        <li>
          <a href="/pictures" class="<?= $_SERVER["REQUEST_URI"] === "/pictures" ? "active" : "" ?>">Gallerie</a>
        </li>
      ...
      <div class="actions">
        ...
        if (SessionHelpers::isLogin()) : ?>
          <a href="/admin/movies" class="button">Admin</a>
