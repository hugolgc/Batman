...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 02 fév. 2023 à 21:56
...
(2, 'The Dark Knight Rises', '2012-07-25', 'https://www.themoviedb.org/t/p/w600_and_h900_bestv2/ApcGBERN0p9I0nDOIwJeEmpnLU5.jpg', '', '', 'Afin que l\'image de l\'ex-procureur Harvey Dent reste un modèle du genre pour les citoyens de Gotham City, Batman a endossé les crimes de ce dernier et a été chassé de la ville par les autorités. Huit ans plus tard, alors que Gotham City est de nouveau sûre, le commissaire Gordon tombe sur un complot qui vise à détruire la ville de l\'intérieur. Il fait appel à Batman. Ce dernier devra faire face à la mystérieuse Selina Kyle et à Bane, un adversaire mortel, qui veut mettre en pièce le symbole Batman.', 'The Dark Knight Rises est un film de super-héros qui se déroule huit ans après les événements du film précédent, The Dark Knight. Batman a abandonné son costume depuis le procès de Harvey Dent et Gotham est en paix grâce à la loi Dent. Cependant, un nouveau criminel nommé Bane arrive à Gotham et prend la ville en otage, en faisant exploser une bombe dans un tunnel de métro. Alors que la police et l\'armée luttent pour reprendre le contrôle de la ville, Bane révèle ses véritables intentions : il a enlevé le milliardaire Bruce Wayne et l\'a laissé pour mort dans une prison inévitable.\r\n\r\nPendant ce temps, un voleur nommé Selina Kyle se fraye un chemin dans la vie de Bruce Wayne et s\'implique dans la lutte pour sauver Gotham. Alors que Bruce se remet de ses blessures, il apprend la véritable identité de Bane et se met en quête de le vaincre. Il est aidé par son ancien allié, le commissaire Gordon, et par un nouveau venu à Gotham, John Blake, un jeune policier qui pense que Bruce est toujours en vie.\r\n\r\nAu cours de la bataille qui se déroule dans les rues de Gotham, Batman affronte Bane dans un duel final qui déterminera le sort de la ville. Après un long combat épique, Batman réussit à vaincre Bane et à neutraliser la bombe. Il disparaît ensuite, laissant croire à sa mort pour protéger son identité secrète et pour permettre à Gotham de continuer à vivre en paix.\r\n\r\nThe Dark Knight Rises met en évidence les thèmes de la justice, de la rédemption et du sacrifice. Il montre comment Batman, malgré ses blessures et ses faiblesses, peut continuer à se battre pour ce qui est juste et comment les gens peuvent se rallier pour sauver leur ville. Le film conclut avec succès la trilogie de Nolan sur le personnage de Batman, en offrant une conclusion épique à l\'histoire de l\'homme masqué de Gotham.', 78, 250000000, 1081041287, 204, '{}'),
(3, 'The Dark Knight : Le Chevalier noir', '2008-08-13', 'https://www.themoviedb.org/t/p/w600_and_h900_bestv2/pdLAyRqMEnL6pzkVgYwMS0a3fEm.jpg', '', '', 'La suite de Batman Begins, The Dark Knight, le réalisateur Christopher Nolan et l\'acteur Christian Bale, qui endosse à nouveau le rôle de Batman/Bruce Wayne dans sa guerre permanente contre le crime. Avec l\'aide du Lieutenant de Police Jim Gordon et du Procureur Harvey Dent, Batman entreprend de démanteler définitivement les organisations criminelles de Gotham. L\'association s\'avère efficace, mais le trio se heurte bientôt à un nouveau génie du crime, plus connu sous le nom du Joker, qui va plonger Gotham dans l\'anarchie et pousser Batman à la limite entre héros et assassin. Heath Ledger interprète Le Joker : le méchant suprême et Aaron Eckhart joue le rôle de Dent. Maggie Gyllenhaal complète le casting en tant que Rachel Dawes. De retour après Batman Begins, Gary Oldman est à nouveau Gordon, Michael Caine interprète Alfred, et Morgan Freeman est Lucius Fox.', '', 85, 185000000, 1004558444, 153, '{}');
